...
{
    public class DbReadOnlyService
    {
        private readonly DbContextOptions<NadekoContext> options;
        private readonly DbContextOptions<NadekoContext> migrateOptions;

        public DbReadOnlyService(IBotCredentials creds)
        {

            var builder = new SqliteConnectionStringBuilder($"{creds.Db.ConnectionString};mode=readonly");
